...
<div class="relative bg-navy pt-[120px] pb-16 px-6 overflow-hidden">
  <div class="absolute inset-0 opacity-25" style="background:url('{{ asset($category->image ?? 'images/no.png') }}') center/cover no-repeat"></div>
  ...
  <div class="relative max-w-[1280px] mx-auto text-center">
    ...
    <p class="text-[15px] text-white/70 max-w-[600px] mx-auto leading-relaxed">{!! $category->description !!}</p>
  </div>
</div>
