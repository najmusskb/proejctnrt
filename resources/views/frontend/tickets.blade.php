...
<section class="tickets-container">
    <div class="tickets-grid">
        ...
        <a href="{{ route('tour.detail', $tour->slug) }}" class="ticket-card">
            <img src="{{ asset($tour->image ?? 'frontend/images/placeholder.jpg') }}" alt="{{ $tour->name }}" class="ticket-bg">
            ...
            <div class="ticket-bottom">
                <div class="ticket-price-box">
                    ...
                    <div class="ticket-price-val">€{{ number_format($tour->price, 0) }}</div>
                </div>
