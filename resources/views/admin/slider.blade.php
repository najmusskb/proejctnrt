                    ...
                    <div class="card-body table-card-body">
                        <form method="post" action="{{ (@$sliderData) ? route('slider.update', $sliderData->id) : route('slider.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="subtitle" value="{{ @$sliderData->subtitle }}" class="form-control form-control-sm shadow-none" id="subtitle">
                                </div>

                                <label for="heading" class="col-sm-3 col-form-label">Heading</label>
                                <div class="col-sm-9">
                                    <input type="text" name="heading" value="{{ @$sliderData->heading }}" class="form-control form-control-sm shadow-none" id="heading">
                                </div>

                                <label for="button_text" class="col-sm-3 col-form-label">Button Text</label>
                                <div class="col-sm-9">
                                    <input type="text" name="button_text" value="{{ @$sliderData->button_text }}" class="form-control form-control-sm shadow-none" id="button_text">
                                </div>

                                <label for="button_url" class="col-sm-3 col-form-label">Button URL</label>
                                <div class="col-sm-9">
                                    <input type="text" name="button_url" value="{{ @$sliderData->button_url }}" class="form-control form-control-sm shadow-none" id="button_url">
                                </div>

                                <label for="video_url" class="col-sm-3 col-form-label">Video URL</label>
                                <div class="col-sm-9">
                                    <input type="text" name="video_url" value="{{ @$sliderData->video_url }}" class="form-control form-control-sm shadow-none" id="video_url">
                                </div>
