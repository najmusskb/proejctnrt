                        ...
                        <form action="{{ (@$productData) ? route('product.update', $productData->id) : route('product.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputAddress" class="col-sm-3 col-form-label">Old Price (Discount) <small class="text-muted">(optional - will show strikethrough)</small></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="old_price" value="{{ (@$productData) ? @$productData->old_price : old('old_price') }}" class="form-control form-control-sm shadow-none">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-sm-3 col-form-label">Brand <span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputCpassword" class="col-sm-3 col-form-label">Hot Product</label>
                                        <div class="col-sm-9">
                                            <input type="checkbox" name="is_hot" value="1" {{ @$productData->is_hot == 1 ? 'checked' : '' }}> <span>Check Hot Product</span>
                                        </div>
                                    </div>
